...
export default function SystemSecurityLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="space-y-6">
        <div className="flex items-center gap-4">
            ...
            <div className="inline-block bg-gradient-to-r from-purple-500 to-indigo-600 px-4 py-2 rounded-lg shadow-lg">
                <h1 className="text-2xl font-bold text-white tracking-tight">System & Security</h1>
            </div>
        </div>

        <div className="inline-block bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg px-4 py-3 shadow-lg">
            <p className="text-white">High-level system oversight, audit logs, and data export.</p>
        </div>
